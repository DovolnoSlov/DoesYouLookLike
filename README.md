...
- в случае необходимости переобучения модели - запустить model_train.py, и обратить внимание на ключ key_load_train_images в конфиг-файле, т.к. тренировочные изображения в сам проект не перенесены.
